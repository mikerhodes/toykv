...
impl SSTables {
    ...
    pub(crate) fn iters(
        ...
        self.sstables.iter(lower_bound, upper_bound)
    }
...
mod tests {
    ...
    fn test_seek_to_key_exact_match() {
        ...
        .unwrap();
        table_iterator
            .seek_to_key(Bound::Included(b"c_cherry"))
            .unwrap();
    ...
    fn test_seek_to_key_non_existent_key() {
        ...
        .unwrap();
        table_iterator
            .seek_to_key(Bound::Included(b"b_banana"))
            .unwrap();
        ...
        table_iterator
            .seek_to_key(Bound::Included(b"d_date"))
            .unwrap();
    ...
    fn test_seek_to_key_before_first_key() {
        ...
        .unwrap();
        table_iterator
            .seek_to_key(Bound::Included(b"a_apple"))
            .unwrap();
    ...
    fn test_seek_to_key_after_last_key() {
        ...
        .unwrap();
        table_iterator
            .seek_to_key(Bound::Included(b"z_zucchini"))
            .unwrap();
    ...
    fn test_seek_to_key_multiple_seeks() {
        ...
        table_iterator
            .seek_to_key(Bound::Included(b"e_elderberry"))
            .unwrap();
        let record = table_iterator.next().unwrap().unwrap();
        ...
        table_iterator
            .seek_to_key(Bound::Included(b"z_zebra"))
            .unwrap();
        assert!(table_iterator.next().is_none());
    }
    ...
    fn test_seek_to_key_large_table() {
        ...
        table_iterator
            .seek_to_key(Bound::Included(b"key000500"))
            .unwrap();
    ...
    fn test_seek_to_key_empty_key() {
        ...
        .unwrap();
        table_iterator
            .seek_to_key(Bound::Included(b"" as &[u8]))
            .unwrap();
